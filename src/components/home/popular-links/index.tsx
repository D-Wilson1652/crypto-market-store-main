...
import PopularLinkGroup from "../../common/popular-links/popular-link-group";
import PopularNavLink from "../../common/popular-links/popular-nav-link";
...
const PopularLinks = () => {
    ...
    return (
        <div className="container px-4 py-3.5 sm:px-6 lg:py-6 4xl:py-9 mb-7 lg:mb-14">
            <Text
                tag="h2"
            ...
            <div className="flex justify-between flex-wrap border-b">
                {popularLinks.map((group, index) => (
                    <div
                        className="flex flex-col gap-8 px-6 4xl:px-8 2xl:border-r last:border-r-0"
