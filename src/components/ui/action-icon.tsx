    ...
    variant: {
        solid: {
            ...
            color: {
                ...
                invert: "bg-white text-primary focus:ring-gray-dark hover:enabled:bg-gray-dark hover:enabled:text-white",
        ...
        flat: {
            ...
            color: {
                ...
                danger: "bg-red-lighter hover:enabled:bg-red-dark/20 focus:ring-red/30 text-red-dark",
        ...
        outline: {
            ...
            color: {
                ...
                danger: "hover:enabled:bg-red-lighter/40 focus:ring-red/30 text-red-dark border-red hover:enabled:border-red-dark ",
        ...
        text: {
            ...
            color: {
                ...
                warning:
                    "hover:text-orange-dark focus:ring-orange/30 text-orange",
            },
        },
    },
};
