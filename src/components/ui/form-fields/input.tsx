    ...
    variant: {
        ...
        flat: {
            ...
            color: {
                ...
                danger: "bg-red-lighter/70 not-read-only:hover:enabled:bg-red-lighter/90 focus:ring-red/30 text-red-dark",
        ...
        outline: {
            ...
            color: {
                ...
                danger: "not-read-only:hover:enabled:border-red not-read-only:focus:enabled:border-red focus:ring-red/30",
...
export interface InputProps
    ...
    endIconOnClick?: (event: React.MouseEvent) => void;
...
const Input = forwardRef<HTMLInputElement, InputProps>(
    (
        ...
        return (
            <div className={cn(containerClasses.base, className)}>
                    ...
                    >
                        ...
                        <input
                            ...
                            className={cn(
                                ...
                                (clearable || startIcon || endIcon) &&
                                    "absolute inset-0",
                                startIcon &&
                                    inputClassesWithIcon.startPadding.size[
                                        size
                                    ],
                                endIcon &&
                                    inputClassesWithIcon.endPadding.size[size],
