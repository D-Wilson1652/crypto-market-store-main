export const DefaultListingIcon: React.FC<React.SVGAttributes<object>> = (
    props
) => {
    return (
        <svg
        ...
        >
            <g>
                <path
                    d="M463.5,32h-336C101.309,32,80,53.309,80,79.5v40V384H7.5c-4.142,0-7.5,3.358-7.5,7.5v40C0,457.691,21.309,479,47.5,479h336
