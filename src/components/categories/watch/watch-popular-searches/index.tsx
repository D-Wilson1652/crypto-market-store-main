...
import WatchPopularSearchesCarousel from "./watch-popular-searches-carousel";
import Text from "@/components/ui/typography/text";

const WatchPopularSearches = () => {
...
export default WatchPopularSearches;
